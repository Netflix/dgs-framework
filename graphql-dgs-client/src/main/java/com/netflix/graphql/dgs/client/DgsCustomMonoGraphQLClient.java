...
/**
 * Reactive GraphQL client that delegates the HTTP call to a user-supplied {@link MonoRequestExecutor}.
 ...
 */
public class DgsCustomMonoGraphQLClient implements DgsMonoGraphQLClient {
