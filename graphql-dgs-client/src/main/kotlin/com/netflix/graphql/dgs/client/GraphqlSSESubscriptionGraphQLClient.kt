 ...
 */
@Deprecated(
    "Tied to Jackson 2. Migrate to DgsGraphqlSSESubscriptionGraphQLClient, which accepts any DgsJsonMapper. " +
        "This class will be removed in a future release.",
    ReplaceWith("DgsGraphqlSSESubscriptionGraphQLClient", "com.netflix.graphql.dgs.client.DgsGraphqlSSESubscriptionGraphQLClient"),
)
