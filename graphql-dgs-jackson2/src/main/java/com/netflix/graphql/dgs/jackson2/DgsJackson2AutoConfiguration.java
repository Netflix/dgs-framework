 ...
 *
 * <p>When this module is on the classpath, Jackson 2 is used by default.
 * Runs BEFORE DgsSpringGraphQLAutoConfiguration so that the Jackson 2 bean
 * takes precedence over the Jackson 3 default.
 *
 * <p>To override and use Jackson 3 even when this module is present, set:
 * {@code dgs.graphql.preferred-json-mapper=jackson3}
 */
@AutoConfiguration(
...
public class DgsJackson2AutoConfiguration {
    ...
    public DgsJsonMapper dgsJsonMapper() {
        return new Jackson2DgsJsonMapper();
    }
}
