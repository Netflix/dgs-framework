...
/**
 * {@link ArgumentResolver} adapter for {@link SyncHandlerMethodArgumentResolver},
 * which allows leveraging existing Spring WebFlux argument resolvers.
 */
public class SyncHandlerMethodArgumentResolverAdapter implements ArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, DataFetchingEnvironment dfe) {
        ...
        var request = requestData.getServerRequest();
        if (request == null) {
