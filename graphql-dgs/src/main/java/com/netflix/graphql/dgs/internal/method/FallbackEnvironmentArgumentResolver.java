...
/**
 * Resolves arguments based on the name by looking for any matching arguments in the current
 * {@link DataFetchingEnvironment}. Intended as a fallback if no other resolvers can handle the argument.
 */
